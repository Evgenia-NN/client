        ...
        <nav class="bg-white shadow-sm dark:bg-neutral-700">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
                ...
                <div class="flex items-center space-x-2 lg:hidden">
                    ...
                    <UiDarkToggle />
                    <button @click="toggleMenu" type="button" class="inline-flex items-center p-2 size-10 justify-center text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-rose-500">
                ...
                <div class="hidden lg:flex lg:items-center lg:space-x-4 lg:order-2">
                    ...
                    <div class="relative">
                        ...
                        <input v-model="search" type="search" id="search-navbar" class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-rose-500 focus:border-rose-500 dark:bg-neutral-700 dark:border-neutral-400 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-rose-500 dark:focus:border-rose-500" placeholder="Поиск...">
                    </div>
                </div>
                ...
                <div :class="[
                    ...
                    <div v-if="searchOpen" class="relative w-full mt-3 lg:hidden">
                        ...
                        <input v-model="search" type="search" id="search-navbar-mobile" class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-cyan-500 focus:border-cyan-500 dark:bg-neutral-700 dark:border-gray-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-cyan-500 dark:focus:border-cyan-500" placeholder="Поиск...">
                    </div>
