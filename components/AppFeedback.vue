<template>
    <form @submit.prevent="submitForm" class="w-120 p-4 md:py-8">
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input v-model="formName" type="text" name="name" id="name" class="text-white block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-1 border-neutral-700/20 appearance-none dark:text-white dark:border-neutral-500 dark:focus:border-rose-500 focus:outline-none focus:ring-0 focus:border-white peer" placeholder=" " required />
        ...
        <div>
            ...
            <textarea  v-model="formMessage" id="message" rows="4" class="block p-2.5 w-full text-sm rounded-lg border border-neutral-700/20 bg-neutral-700/20 focus:ring-rose-500 focus:border-rose-500 dark:bg-white/20 dark:border-neutral-500 dark:placeholder-white dark:text-white dark:focus:ring-white dark:focus:border-white" placeholder="Оставьте сообщение..."></textarea>
        </div>
